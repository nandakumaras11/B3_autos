    ...
    <section className="legislationPage">
      ...
      <div className="legislation-content">
        <span className="highlite-content">
          HSRP: High Security Registration Plate that is FULLY COMPLIANT to
        </span>
        <p>
          <span className="highlite-content">Rule 50 of CMVR-1989: 	</span>
          Technical specifications of the Registration Mark assigned to a motor vehicle are to be in the form of a Security License Plate.

        </p>
        <span className="highlite-content">Rule 51 of CMVR-1989: </span>
        Motor vehicle category specific size of letters and numerals of the Registration Mark and the space between them.
      ...
      <div className="legislation-list">
        <ul>
          ...
          <li>
            Aluminum Base Plate: Radiused at corners, border-embossed with India imprint
          </li>
          <li>
            Reflective materials, clear, durable and readable from a longer distance to meet ISO: 7591 of 1982 and AIS: 159
          </li>
          ...
          <li>
            3rd License Plate/Regn. Mark: Hologram-embedded destructible inside windshield sticker
          </li>
          <li>
          ...
          <li>
            <span className="highlite-content">
              Certification: Type approval certificate from an accredited testing agency
      ...
      <div className="Legal-id">
        ...
        <p>
          <span className="highlite-content">
            {" "}
            B3 Autos has a Legal ID of type approval with Code ‘YA’
          </span>
          assigned by the testing agency for compliance and certified for use as fit for purpose.
        </p>
        <p>
          Every{" "}
          <span className="highlite-content">B3 Autos HSRP  </span> is permanently marked with a ten digit unique laser-branded IDENTIFIER for tracking and tracing. The Legal ID can also be found on the 3rd LP on vehicles with a windshield.
        </p>
        <h3>VAHAN – National Registry:</h3>
        <p>
          Type approved manufacturers of HSRP – High Security Registration Plate – are provided access to VAHAN, the National Registry of MoRTH – Ministry of Road Transport & Highways
        </p>
      </div>
